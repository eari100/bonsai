...
from bonsai.models.ssd300 import modeling, params


def run_model():
    # 1. Download h5 file
    model_ckpt_path = snapshot_download("keras/vgg_16_imagenet")

    # 2. Load pretrained model
    config = modeling.ModelCfg.vgg_16()
    ...
    # Profile a few steps
    jax.profiler.start_trace("/tmp/profile-vgg16")
    for _ in range(5):
