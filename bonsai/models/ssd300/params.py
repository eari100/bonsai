...
from bonsai.models.ssd300 import modeling as model_lib
...
def _get_key_and_transform_mapping():
    ...
    return {
        ...
        # conv_block 3
        r"^layers/vgg_backbone/layers/conv2d_7/vars/0$": ("conv_block3.conv_layers.0.kernel", None),
        r"^layers/vgg_backbone/layers/conv2d_7/vars/1$": ("conv_block3.conv_layers.0.bias", None),
        r"^layers/vgg_backbone/layers/conv2d_8/vars/0$": ("conv_block3.conv_layers.1.kernel", None),
        r"^layers/vgg_backbone/layers/conv2d_8/vars/1$": ("conv_block3.conv_layers.1.bias", None),
        r"^layers/vgg_backbone/layers/conv2d_9/vars/0$": ("conv_block3.conv_layers.2.kernel", None),
        r"^layers/vgg_backbone/layers/conv2d_9/vars/1$": ("conv_block3.conv_layers.2.bias", None),
        # conv_block 4
        r"^layers/vgg_backbone/layers/conv2d_10/vars/0$": ("conv_block4.conv_layers.0.kernel", None),
        r"^layers/vgg_backbone/layers/conv2d_10/vars/1$": ("conv_block4.conv_layers.0.bias", None),
        r"^layers/vgg_backbone/layers/conv2d_11/vars/0$": ("conv_block4.conv_layers.1.kernel", None),
        r"^layers/vgg_backbone/layers/conv2d_11/vars/1$": ("conv_block4.conv_layers.1.bias", None),
        r"^layers/vgg_backbone/layers/conv2d_12/vars/0$": ("conv_block4.conv_layers.2.kernel", None),
        r"^layers/vgg_backbone/layers/conv2d_12/vars/1$": ("conv_block4.conv_layers.2.bias", None),
        # Classifier
...
def create_model_from_h5(
    ...
    """
    Load h5 weights from a file, then convert & merge into a flax.nnx VGG16 model.
